...
- 정산
  - 마지막 모임 수입(회비): (TBD)
  - 마지막 모임 지출(간식): (TBD)
  - 8월부터 누적 수입(회비): 2,400,000원 (총 480명)
